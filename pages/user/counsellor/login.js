    ...
    <>
        <div className="bg-[#e3f2fd] min-h-screen p-12 flex justify-center text-slate-800 items-center">
          <div className="bg-white p-10 rounded-lg text-center w-full h-full md:w-1/2 lg:w-1/3 border border-[#bee1fa]">
              ...
              <div className="text-[#673ab7] font-bold text-2xl my-4">Counsellor Login</div>
              ...
              <div><button className="w-full py-2 text-white bg-[#673ab7] rounded font-medium my-4 hover:bg-[#563199]" onClick={counsellorLogin}>Login</button></div>
          </div>
        </div>
    </>
  )
